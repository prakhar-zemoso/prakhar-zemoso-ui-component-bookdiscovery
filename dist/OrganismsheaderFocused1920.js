...
export default function OrganismsheaderFocused1920(props) {
  ...
  return /*#__PURE__*/React.createElement(View, _extends({
  ...
  }, rest, getOverrideProps(overrides, "OrganismsheaderFocused1920")), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "12px",
    position: "absolute",
    top: "19.1px",
    left: "300px",
    ...
    padding: "0px 0px 0px 0px"
  }, getOverrideProps(overrides, "Frame 29")), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "10px",
    direction: "row",
    width: "fit-content",
    alignItems: "center",
  ...
  }, getOverrideProps(overrides, "molecules/button/primary/molecules/headernav/wo icon/molecules/headernav/w icon7952844"))), /*#__PURE__*/React.createElement(Moleculesbuttonprimarymoleculesheadernavwoiconmoleculesheadernavwicon, _extends({
    display: "flex",
    gap: "4px",
    direction: "row",
    width: "fit-content",
    ...
    borderRadius: "4px",
    padding: "4px 4px 4px 8px"
  }, getOverrideProps(overrides, "molecules/button/primary/molecules/headernav/wo icon/molecules/headernav/w icon7952845")))), /*#__PURE__*/React.createElement(Atomslogonew, _extends({
    display: "flex",
    gap: "10px",
    position: "absolute",
    top: "19px",
  ...
  }, getOverrideProps(overrides, "molecules/searchnew1 close icon"))), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "24px",
    position: "absolute",
    top: "14px",
    left: "1732px",
    ...
    alignItems: "center",
    padding: "0px 0px 0px 0px"
  }, getOverrideProps(overrides, "Frame 30")), /*#__PURE__*/React.createElement(Atomsiconsnotification, _extends({
    width: "24px",
    height: "22.24px",
    shrink: "0",
    overflow: "hidden",
