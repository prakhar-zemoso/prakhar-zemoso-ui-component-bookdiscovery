...
export default function OrganismsheaderInactive3(props) {
  ...
  return /*#__PURE__*/React.createElement(View, _extends({
  ...
  }, rest, getOverrideProps(overrides, "OrganismsheaderInactive3")), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "10px",
    position: "absolute",
    top: "28.08%",
    bottom: "27.8%",
  ...
  }, getOverrideProps(overrides, "molecules/button/primary/molecules/headernav/wo icon/molecules/headernav/w icon7763454"))), /*#__PURE__*/React.createElement(Moleculesbuttonprimarymoleculesheadernavwoiconmoleculesheadernavwicon, _extends({
    display: "flex",
    gap: "4px",
    position: "absolute",
    top: "19.1px",
    ...
    borderRadius: "4px",
    padding: "4px 4px 4px 8px"
  }, getOverrideProps(overrides, "molecules/button/primary/molecules/headernav/wo icon/molecules/headernav/w icon7763455"))), /*#__PURE__*/React.createElement(Moleculessearchnew1, _extends({
    display: "flex",
    gap: "4px",
    position: "absolute",
    top: "15px",
  ...
  }, getOverrideProps(overrides, "molecules/searchnew1"))), /*#__PURE__*/React.createElement(Atomsavatar, _extends({
    display: "flex",
    gap: "10px",
    position: "absolute",
    top: "20.59%",
