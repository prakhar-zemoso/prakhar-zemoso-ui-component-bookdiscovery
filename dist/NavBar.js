...
export default function NavBar(props) {
  ...
  return /*#__PURE__*/React.createElement(Flex, _extends({
    ...
    backgroundImage: "linear-gradient(-45deg, rgba(140,82,198,1), rgba(104,55,153,1))"
  }, rest, getOverrideProps(overrides, "NavBar")), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "2px",
    direction: "row",
    width: "fit-content",
    height: "20px",
  ...
  }, getOverrideProps(overrides, "Logo11424081")), /*#__PURE__*/React.createElement(Icon, _extends({
    width: "18px",
    height: "18px",
    viewBox: {
      minX: 0,
    ...
    shrink: "0",
    position: "relative"
  }, getOverrideProps(overrides, "Star 1"))), /*#__PURE__*/React.createElement(Text, _extends({
    fontFamily: "Inter",
    fontSize: "20px",
    fontWeight: "400",
    color: "rgba(0,0,0,1)",
    ...
    whiteSpace: "pre-wrap",
    children: "Logo"
  }, getOverrideProps(overrides, "Logo11424083")))), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "40px",
    direction: "row",
    width: "633.5px",
    alignItems: "center",
    ...
    position: "relative",
    padding: "0px 0px 0px 0px"
  }, getOverrideProps(overrides, "Frame 32111424084")), /*#__PURE__*/React.createElement(Text, _extends({
    fontFamily: "Inter",
    fontSize: "16px",
    fontWeight: "400",
    color: "rgba(0,0,0,1)",
    ...
    whiteSpace: "pre-wrap",
    children: "Dashboard"
  }, getOverrideProps(overrides, "Dashboard"))), /*#__PURE__*/React.createElement(Text, _extends({
    fontFamily: "Inter",
    fontSize: "16px",
    fontWeight: "400",
    color: "rgba(0,0,0,1)",
    ...
    whiteSpace: "pre-wrap",
    children: "Jobs"
  }, getOverrideProps(overrides, "Jobs"))), /*#__PURE__*/React.createElement(Text, _extends({
    fontFamily: "Inter",
    fontSize: "16px",
    fontWeight: "400",
    color: "rgba(0,0,0,1)",
    ...
    whiteSpace: "pre-wrap",
    children: "Applicants"
  }, getOverrideProps(overrides, "Applicants"))), /*#__PURE__*/React.createElement(Text, _extends({
    fontFamily: "Inter",
    fontSize: "16px",
    fontWeight: "400",
    color: "rgba(0,0,0,1)",
    ...
    whiteSpace: "pre-wrap",
    children: "Company"
  }, getOverrideProps(overrides, "Company")))), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "32px",
    direction: "row",
    width: "633.5px",
    ...
    position: "relative",
    padding: "0px 0px 0px 0px"
  }, getOverrideProps(overrides, "Frame 32111424089")), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "8px",
    direction: "column",
    width: "300px",
    shrink: "0",
    ...
    position: "relative",
    padding: "0px 0px 0px 0px"
  }, getOverrideProps(overrides, "SearchField"))), /*#__PURE__*/React.createElement(View, _extends({
    width: "24px",
    height: "24px",
    shrink: "0",
    overflow: "hidden",
    ...
    left: "16.67%",
    right: "16.67%"
  }, getOverrideProps(overrides, "Vector")))), /*#__PURE__*/React.createElement(Image, _extends({
    width: "45px",
    height: "45px",
    shrink: "0",
    position: "relative",
