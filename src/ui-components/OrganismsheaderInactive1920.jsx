...
export default function OrganismsheaderInactive1920(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "OrganismsheaderInactive1920")}
    >
      <Atomslogonew
        display="flex"
        gap="10px"
      ...
      >
        ...
        <Moleculesbuttonprimarymoleculesheadernavwoiconmoleculesheadernavwicon
          ...
          {...getOverrideProps(
            overrides,
            "molecules/button/primary/molecules/headernav/wo icon/molecules/headernav/w icon7892816"
          )}
        ></Moleculesbuttonprimarymoleculesheadernavwoiconmoleculesheadernavwicon>
        <Moleculesbuttonprimarymoleculesheadernavwoiconmoleculesheadernavwicon
          display="flex"
          ...
          {...getOverrideProps(
            overrides,
            "molecules/button/primary/molecules/headernav/wo icon/molecules/headernav/w icon7892817"
          )}
        ></Moleculesbuttonprimarymoleculesheadernavwoiconmoleculesheadernavwicon>
      </Flex>
      <Moleculessearchnew1
